...
import 'package:logistic_app/helpers/map_requests.dart';
import 'package:logistic_app/helpers/style.dart';
//import 'package:logistic_app/models/driver.dart';
import 'package:logistic_app/models/route.dart';
import 'package:geolocator/geolocator.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:uuid/uuid.dart';
import 'dart:ui' as ui;

enum Show { DESTINATION_SELECTION, PICKUP_SELECTION, PROCEED }
...
class ShippingProvider extends ChangeNotifier {
  ...
  ShippingProvider() {
    /*if (infoStream == null) {
      infoStream = Stream<double>.periodic(Duration(seconds: 250), (x) {
  ...
  setPickCoordinates({LatLng? coordinates}) async {
