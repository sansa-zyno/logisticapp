...
class FundWithBank extends StatefulWidget {
  const FundWithBank({Key? key}) : super(key: key);

  @override
  State<FundWithBank> createState() => _FundWithBankState();
}

class _FundWithBankState extends State<FundWithBank> {
  ...
  FundWithBank() async {
    ...
    setState(() {});
    print(username);
    final res = await HttpService.postWithFiles(Api.FundWithBank, {
      "username": username,
      "date": dte,
