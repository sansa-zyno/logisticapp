...
class FundWithSkrill extends StatefulWidget {
  const FundWithSkrill({Key? key}) : super(key: key);

  @override
  State<FundWithSkrill> createState() => _FundWithSkrillState();
}

class _FundWithSkrillState extends State<FundWithSkrill> {
  ...
  FundWithSkrill() async {
    /*loading = true;
    setState(() {});
    print(username);
    final res = await HttpService.postWithFiles(Api.FundWithSkrill, {
      "username": username,
      "date": dte,
